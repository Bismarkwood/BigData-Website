...
import ecLogo from '../../assets/Client Logos/EC.png'
import indomieLogo from '../../assets/Client Logos/Indomie.png'
import ntlLogo from '../../assets/Client Logos/NTL.png'
import ntmelLogo from '../../assets/Client Logos/NTMEL.png'
...
import wcfLogo from '../../assets/Client Logos/World Cocoa Foundation.png'
import ecomLogo from '../../assets/Client Logos/ECOM.png'
...
import ugLogo from '../../assets/Client Logos/UG Logo.png'
