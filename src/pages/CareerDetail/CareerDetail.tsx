    ...
    <main className="career-detail">
      ...
      <section className="career-detail__hero">
        ...
        <div className="career-detail__meta">
          <span className="career-detail__meta-item">📍 {role.location}</span>
          <span className="career-detail__meta-item">⏰ {role.type}</span>
          <span className="career-detail__meta-item">🏢 {role.department}</span>
        </div>
      </section>
